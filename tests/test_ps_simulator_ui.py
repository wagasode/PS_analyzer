...
class PsSimulatorUiTest(unittest.TestCase):
    def test_rendered_ui_fetches_repo_local_sample_dataset_copy(self) -> None:
        ...
        self.assertIn('id="battle-throw-advice"', html)
        self.assertIn("3/2/2 投げ判定", html)
        self.assertIn("const throwAdviceRoundNumbers = [1, 2, 3];", html)
        ...
        self.assertIn("function renderBattleThrowAdvice()", html)
